...
warning.setAttribute("class", "warning fa-solid fa-triangle-exclamation");
...
submitBtnRegi.addEventListener("click", (e) => {
    ...
    if (nameInput.value !== "" && emailInputRegi.value !== "" && passwordInputRegi.value !== "") {
        if (emailInputRegi.value.match(checkEmail)) {
            ...
            let text = document.createTextNode("Email Error .. ex : mkyong-100@yahoo.com");
            error.appendChild(text);
